        <style>
            ...
            .container {
                padding: 30px 10px; font-size: 16px; line-height: 1.4; color: #737373; background: #f0f0f0;
        ...
        <h2><span>404</span>Página no encontrada</h2>
        <p>¡Vaya! Algo salió mal.<br /><br />La página que busca no existe o no se encuentra disponible.</p>
    </div>
